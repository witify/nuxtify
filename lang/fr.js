export default {
  pages: {
    ...
    about: {
      ...
      'boldness-text': 'Notre équipe est audacieuse et innovante. Nous osons saisir les opportunités et transformer en atouts les défis qui peuvent se présenter sur votre route. ', 
      excellence: 'Excellence',
      'excellence-text-1': 'L’excellence est au cœur de nos valeurs. Chaque projet, interaction et action est basée sur un désir profond d’offrir une qualité supérieure et le meilleur de nous-mêmes.',
      'excellence-text-2': 'Nous combinons talent et travail tenace afin de fournir les meilleurs outils et les meilleurs résultats. Notre équipe comprend votre désir de se différentier, c’est pourquoi elle prend fierté à concrétiser votre idée sous la forme d’un produit digital puissant et remarquable.',
      'products-super': "Ce qui rend notre travail <strong class='has-text-weight-bold'>SUPER</strong>",
      'products-super-text': "Notre équipe répond aux normes les plus élevées et s'approprie les résultats de votre projet. Votre succès est notre fierté.",
      secure: 'Sécuritaire',
      'secure-text': "Toutes nos applications Web sont protégées contre les <strong>cyber-attaques</strong> communes et appliquent les meilleures pratiques en termes de confidentialité et de <strong>protection des données</strong>.",
      usable: 'Utilisation aisée',
      'usable-text': "Chaque produit numérique que nous fabriquons est conçu pour offrir la <strong>meilleure expérience utilisateur</strong> possible. Nos interfaces sont rapides, en plus d'être faciles à utiliser et à apprendre.",
      powerful: 'Puissant',
      'powerful-text': "Chaque produit que nous concevons est sur mesure et spécialement conçu pour notre client. En adoptant une solution personnalisée, nombre de nos clients ont assisté à une <strong>mise à niveau considérable en termes de performances, d’efficacité et de convivialité</strong>.",
      efficient: 'Efficace',
      'efficient-text': "Nos produits sont rapides sur toutes les plateformes. Ils sont adaptés aux besoins de nos clients, <strong>rendant chaque action plus rapide et plus facile à apprendre</strong>.",
      reliable: 'Robuste',
      'reliable-text': "Chaque solution Web est hébergée sur des serveurs grade-entreprise. Vos données sont stockées en toute sécurité et répliquées sur l'info-nuage. La haute qualité de notre code permet des mises à jour faciles et une plus grande fiabilité.",
      collaboration: 'Collaboration',
      'collaboration-text-1': "Nous croyons que chaque succès provient d'une coopération forte et sincère.",
      'collaboration-text-2': "Chez Witify, nous accordons une grande importance au travail d'équipe. Que ce soit en interne, pour assurer une dynamique forte d’auto-assistance. Ou avec notre clientèle, qui repose sur la transparence et une communication accessible à tout moment. Nous sommes ici, nous sommes des êtres humains et nous voulons construire les ponts d’une relation durable.",
      ...
      'collaboration-quote-text': "Witify est l'une des rares agences Web à l'écoute de ses clients. Mes projets ont toujours été réalisés avec soin et rapidité.",
      'collaboration-quote-author-role': "CTO à Acme Inc.",
      boldness: 'Audace',
      'boldness-text-1': "Notre équipe est audacieuse et innovante. Nous osons saisir les opportunités et transformer les défis que vous rencontrerez en atouts.",
      'boldness-text-2': "Chaque épreuve est une occasion de repousser les limites de l’innovation et de la créativité. Nous croyons qu’il est important d’entreprendre des projets, de braver les obstacles et de constamment aspirer à mieux que le statu quo.",
  ...
  project: {
    ...
    boursify: {
      ...
      'paragraph-1': "Boursify est logiciel de simulation boursière événementielle pour les écoles et les entreprises qui souhaitent offrir une expérience éducative et divertissante à leur élèves ou employés.",
      'paragraph-2': "Une simulation boursière évènementielle est un évènement populaire auprès des mordus de la finance, organisé par leurs associations scolaires/étudiantes. Ce genre d’évènement dure généralement une demi-journée ou une journée complète et peut regrouper jusqu’à plusieurs centaines de participants. Dans le cadre de la simulation, les participants se voient devenir des traders, dans le style Wall Street, reçoivent un faux portfolio et doivent transiger des actions à travers un scénario fictif, dans le but de faire le plus d’argent possible.",
      'paragraph-3': "Le tout est très populaire auprès des associations étudiantes en finance des universités et cégeps et est organisé sous forme de compétition. Précédemment, une seule alternative logicielle existait pour les organisateurs désirant héberger ce genre d’évènement.",
      'approach': "Approche",
      'approach-text-1': "Witify devait développer une solution logicielle offrant aux organisateurs en charge de ce type d’évènements, et à leurs participants, une expérience hors-pair, se démarquant grandement du logiciel précédent. Witify a donc du prendre en charge le design de la marque, le développement du produit, la conception d’interfaces et la structure de la plateforme, de A à Z.",
      'approach-text-2': "La solution, 100% clé-en-main, devait permettre la création de scénarios, une plateforme d’administration pour les organisateurs, une gestion de la simulation en temps réel et une plateforme de jeu pour les participants, le tout hébergé sur le cloud. La planification du produit, autant que son développement, et que sa phase test, relevait de l’expertise de l’équipe Witify.",
      'header-text': "La solution permet la <strong>création de scénarios</strong>, une <strong>plateforme d’administration</strong> pour les organisateurs, une gestion de la <strong>simulation en temps réel</strong> et une <strong>plateforme de jeu</strong> pour les participants.",
      'scenario-creation': "Création de scénario",
      'scenario-creation-text': "L'équipe Witify a dû travailler de pair avec les potentiels organisateurs afin d’avoir une interface dédiée à ce type d’utilisateur, leur permettant de rapidement créer des scénarios. Tous les scénarios pouvant posséder une multitude d’informations, le processus devait séparer intuitivement les diverses étapes, tout en offrant la possibilité de rajouter une infinité d’informations. Le générateur a été simplifié de façon à pouvoir y former efficacement de la main d’œuvre pour son utilisation.",
      'simulation-algo': "Algorithmes de simulation",
      'simulation-algo-text': "L’équipe de développeurs a dû acquérir des connaissances spécifiques quant au domaine du produit, soit la finance, afin de développer des algorithmes complexes permettant à la simulation d’offrir son aspect si réaliste. En y joignant des outils technologiques divers, l’équipe a intégré le concept de temps réel dans la simulation, permettant aux portfolios des joueurs et au scénario d’être dynamiquement mis à jour, à la seconde près.",
  ...
  service: {
    ...
    'e-commerce' : {
      ...
      'benefit-1-title': "Flexibilité complète",
      'benefit-1-subtitle': "de la gestion des produits",
      'benefit-2-title': "Aucune limite",
      'benefit-2-subtitle': "aux intégrations",
      'benefit-3-title': "Vitesse incroyable",
      'benefit-3-subtitle': "du chargement des page",
      'benefit-4-title': "Accès total",
      'benefit-4-subtitle': "à l'internationalisation",
      'benefit-5-title': "Intégration",
      'benefit-5-subtitle': "omnicanale",
      'benefit-6-title': "Analyse des résultats",
      'benefit-6-subtitle': "et des performances",
