export default {
  ...
  service: {
    ...
    'custom-application' : {
      ...
      'subtitle': "A unique and personalized solution, developed for your needs and your reality, whatever they are.",
      "unique-app-header": "Do you have a unique application idea that will change the world?",
      "unique-app-text": "The Witify team supports the development of the software to turn your vision into a complete, high-quality application. We know that your project has its own goals, constraints and unique characteristics. Our team is ready to adapt to your needs while guiding you to ensure your success.",
      "adapt-reality-header": "We adapt to your reality",
      "adapt-reality-text-1": "Whether you want to design a prototype or quickly reach a commercial version, we adapt to your reality.",
      "adapt-reality-text-2": "Our team wants to support you in tasks where you lack time or expertise; whether in Product Management, Design, User Experience Development, Software Engineering, Quality Assurance or Integration in a Technology Environment.",
      "adapt-reality-text-3": "Concentrate on your strengths, we take care of the rest.",
      "quality-products-header": "Quality products, always.",
      "quality-products-text": "A good digital product must be intuitive, efficient and scalable. Witify helps you achieve your goals with excellence, without compromising quality.",
      "3-steps-method": "Our method in 3 phases",
      "3-steps-method-text": "Our 3-step methodology is based on active listening and fluid communication that will maximize the success of your product. We want to understand your goals, your customers and really implement the best solution for your project.",
      "project-analysis-header": "Project analysis",
      "project-analysis-subheader": "The analysis phase makes it possible to target the priority needs, better understand the company and its current and long-term positioning.",
      "project-analysis-point-1": "Analysis of project objectives",
      "project-analysis-point-2": "Definition of the typical user",
      "project-analysis-point-3": "Company vision and graphic brand",
      "project-analysis-point-4": "Planning of the schedule of the various phases of prototyping and marketing",
      "app-dev-header": "Application development",
      "app-dev-subheader": "Frequent monitoring allows us to communicate quickly and effectively through the development process.",
      "app-dev-point-1": "Design of visual models and optimization of the user experience",
      "app-dev-point-2": "Back-end and front-end software development",
      "app-dev-point-3": "Dedicated project manager",
      "app-dev-point-4": "Tests and quality assurance",
      "deployment-header": "Deployment and reviews by iteration",
      "deployment-subheader": "A digital product is constantly evolving and must constantly be tweaked to satisfy its target customers.",
      "deployment-point-1": "Deployment and implementation of monitoring tools",
      "deployment-point-2": "Documentation of internal metrics (technological and business)",
      "deployment-point-3": "Training",
      "deployment-point-4": "Follow-ups and iterative reviews",
      'next-big-idea': "Tell us your next big idea & discover unsuspected benefits",
    }
  }
}