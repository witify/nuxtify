<template>
    ...
    <div class="page-process-optimisation">
        ...
        <section class="hero is-main is-process-optimisation is-bold is-large">
            <div class="hero-body">
                <div class="container">
                ...
                <div class="column">
                    <div class="section is-medium">
                        <div class="container is-sm">
                            ...
                            <h2 class="title">
                                Have you reached a growth plateau?
                            </h2>
                            <p class="is-size-4 mb-20">
                            Our services are optimal for companies that are growing or want to grow, already posting some revenue stability and <strong>ready to invest in their expansion.</strong>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="column is-bg is-bg-office">
        ...
        <section class="section is-medium has-text-centered">
            <div class="container is-sm">
                ...
                <h2 class="subtitle mb-80">Nous offrons une gamme de services complète pour un accompagnement et un développement clé en main de A à Z.</h2>
        ...
        <section class="hero is-light is-medium">
            <div class="hero-body">
                <div class="container">
                    ...
                    <h3 class="subtitle is-size-4">Ut varius tincidunt libero. Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi.</h3>
